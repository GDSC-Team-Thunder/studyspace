    ...
    <div className="flex justify-center items-center flex-col h-screen w-screen">
      <div className="flex flex-row justify-between items-center mt-5 w-[95vw]">
        ...
        <div className="flex flex-row ml-auto space-x-4">
          <p className="flex flex-grow-0 text-[24px] font-bold cursor-pointer" onClick={() => navigate("/Signup")}>sign up</p>
          <p className="flex flex-grow-0 text-[24px] font-bold cursor-pointer" onClick={() => navigate("/login")}>log in</p>
        </div>
      </div>

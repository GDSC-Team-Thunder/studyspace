  ...
  return (
    <li className="flex flex-row list-none p-3 w-full items-center justify-between bg-[#1D006F] my-2 rounded-xl">
      <div className="flex flex-auto items-center">
        <img
          className="flex-initial mr-3 cursor-pointer"
          src={Checked}
          alt="Checked"
          onClick={() => props.onIncomplete(props.task)}
        />
        <p
          className="flex-initial text-[#F32FBC] text-left text-bold text-[#FFC806] overflow-wrap"
